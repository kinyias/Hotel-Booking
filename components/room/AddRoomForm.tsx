      ...
      <Form {...form}>
        <form className="space-y-6">
          ...
          />
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Bao nhiêu giường trong phòng</FormDescription>
                <FormControl>
          ...
          />
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Bao nhiêu phòng tắm trong phòng</FormDescription>
                <FormControl>
          ...
          />
              ...
              {room ? (
                  <Button onClick={form.handleSubmit(onSubmit)} type='button' variant='info' className="max-w-[150px]" disabled={isLoading}>
                    {isLoading ? (
                      <>
                  ...
                  <Button onClick={form.handleSubmit(onSubmit)} type='button' variant='success' className="max-w-[150px]" disabled={isLoading}>
                    {isLoading ? (
                      <>
